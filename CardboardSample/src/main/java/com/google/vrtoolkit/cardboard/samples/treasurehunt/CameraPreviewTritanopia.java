 ...
 */
public class CameraPreviewTritanopia extends SurfaceView implements SurfaceHolder.Callback, Camera.PreviewCallback{
    private int test = 0;
    ...
    public CameraPreviewTritanopia(Context context, Camera camera, ImageView filteredImageView, ImageView filteredImageViewRight) {
        super(context);
        mCamera = camera;
    ...
    public void onPreviewFrame(byte[] data, Camera camera) {
        ...
        ColorblindnessTritanopiaFilter colorblindnessTestFilter = new ColorblindnessTritanopiaFilter (getContext(),mFilteredImageView,mFilteredImageViewRight, camera);
