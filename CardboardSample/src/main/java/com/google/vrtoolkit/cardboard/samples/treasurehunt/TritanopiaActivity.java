...
public class TritanopiaActivity extends Activity {

    public static final String TAG = CameraActivity.class.getName();
    private Camera mCamera;
    private CameraPreviewTritanopia mPreview;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tritanopia);
        ...
        if(mCamera!=null) {
            ...
            mPreview = new CameraPreviewTritanopia(this, mCamera, filteredImageView, filteredImageViewRight);
